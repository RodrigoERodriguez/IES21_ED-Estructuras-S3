...
namespace pryRodriguezED_Estructuras
{
    public partial class frmCola : Form
    {
        ...
        {
            if (lblCodigoInfo.Text != "" & lblNombreInfo.Text != "" & lblTramiteInfo.Text != "")
            {
        ...
        private void lblCodigoInfo_Click(object sender, EventArgs e)
        {
            CheckEliminar();
        }
        ...
        private void lblTramiteInfo_Click(object sender, EventArgs e)
        {
            CheckEliminar();
        }
